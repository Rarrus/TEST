...
<body class="m-1 position-relative  " style="background-color: var(--bs-indigo)">
  ...
  <header>
    <nav class="navbar navbar-expand-lg  rounded d-flex flex-lg-column justify-content-around bg-gradient " style="background-color: var(--bs-indigo)">
      <!-- LOGO + TITRE -->
      <a class="navbar-brand text-green text-center rounded top-0 start-0 mb-1 btn active m-2 bg-gradient " id="HAUT" href="#"><img class="img-fluid" src="./../img/logo-site.png" alt="logo du site" style="width: 20%;">TAPY</a>
  ...
  <main>
    <div class=" text-center active rounded m-2  ">
      <h1 class=" border rounded d-inline  " style="color: #90FE9F!important;" id="login">LOGIN</h1>
    </div>
