    ...
    <header>
      <nav class="navbar navbar-expand-lg  rounded d-flex flex-lg-column justify-content-around  ">
        ...
        <div class="collapse navbar-collapse " id="navbarSupportedContent">
          <ul class="navbar-nav mb-lg-2 bg-black d-lg-flex  bg-gradient rounded flex-nowrap border border-white">
        ...
        <div class=" ">
          <form class="  search   " role="search" id="search">
            <div id="search2">
              <img src="./../img/search.svg" alt="" class="text-center style_search">
